...
public class FragmentStructureConfigurer implements FragmentStructureConfiguration {
    ...
    private <A extends PayloadAttribute, C extends PayloadAttributeConfigurer<A, C>> C configureAttribute(String attributeName, Class<A> attributeType, Class<C> configurerType) {
